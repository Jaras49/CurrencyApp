...
public class CryptoCompareImpl implements CryptoCompare {
    ...
    @Override
    public CryptoCompareResponse getData(String startDate, String endDate, String currencyCodeFrom, String currencyCodeTo) {

        URI uri = buildConnectionUri(startDate, endDate, currencyCodeFrom, currencyCodeTo);
        return restTemplate.getForObject(uri, CryptoCompareResponse.class);
    }
